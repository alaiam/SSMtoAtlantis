...
nc_filenameLPON <- paste0(output_path, "/pugetsound_SSM_Atlantis_PCB", PCB_congener, "_LPON_",scenario,"_",year,".nc")
nc_filenameRPON <- paste0(output_path, "/pugetsound_SSM_Atlantis_PCB", PCB_congener, "_RPON_",scenario,"_",year,".nc")
